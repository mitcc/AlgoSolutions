 ...
 * integer n, add/patch elements to the array such that any 
 * number in range [1, n] inclusive can be formed by the 
 * sum of some elements in the array. Return the minimum 
 ...
 * [1], [2], [3], [1,3], [2,3], [1,2,3].
 * Possible sums are 1, 2, 3, 4, 5, 6, which now covers the 
 * range [1, 6].
