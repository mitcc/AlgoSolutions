 ...
 * on if it's off or turning off if it's on). For the nth 
 * round, you only toggle the last bulb. Find how many 
 ...
 * 
 * So you should return 1, because there is only one bulb 
 * is on.
 */
